...
\noindent\begin{tikzpicture}
    ...
    % PANEL
    \node at (270:48mm) {\includegraphics[width=30mm]{sign.png}};
    % move this down?
    \path[postaction={decorate,decoration={text align={center},%
...
\begin{tikzpicture}
    ...
    \foreach [count=\i] \plus/\minus in {%
            00/24,01/23,02/22,03/21,04/20,05/19,
            06/18,07/17,08/16,09/15,10/14,11/13,
            12/12,13/11,14/10,15/09,16/08,17/07,
        ...
        \path[postaction={decorate,decoration={text align={center},text
            ...
            (247.5+15*\i:64mm) arc (247.5+15*\i:262.5+15*\i:64mm);
        \fill (270+15*\i:68mm) -- (271+15*\i:66mm) -- (269+15*\i:66mm);
        \fill (270+15*\i:58mm) -- (271+15*\i:60mm) -- (269+15*\i:60mm);
    }
